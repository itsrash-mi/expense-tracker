...
const baseURL = 'https://api.airtable.com/v0/appty5uCn2cgBjGoa/expense';
const apiKey = 'patU8pwDXChBobWgY.67661c01c63d56ee7b04c17d625b380dcbbc8861fd9ef3f5b946b2880458615c';
...
function addExpense(e) {
    ...
    const category = selectedCategories[0] || ''; // Get the first selected category or default to an empty string
    ...
    .then(data => {
        ...
        loadExpenses();  // Load expenses after successful addition
    })
    .catch(error => {
    ...
    fetch('https://connect.pabbly.com/workflow/sendwebhookdata/IjU3NjUwNTY0MDYzMTA0Mzc1MjY4NTUzMzUxM2Ii_pc', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function loadExpenses(filterCategory = 'All') {
    ...
    .then(data => {
        ...
        // Filter expenses based on selected category and validity
